...
import Encode as en
def encoding():
    opcode={"add":"00000","sub":"00001","ld":"00100","st":"00101","mul":"00110","div":"00111","ls":"01001","rs":"01000","xor":"01010","or":"01011","and":"01100","not":"01101","cmp":"01110","jmp":"01111","jlt":"10000","jgt":"10001","je":"10010","hlt":"10011","movim":"00010","movr":"00011","addf":"00000","subf":"00001","movf":"00010"}
    return opcode
def getKeywords():
...
def main():
    ...
    for i in instructions:
        ...
        if i[0]=="mov":
            if i[2][0]=="$":
                i[0]+="im"
            elif i[1][0]=="R" or i[1][0]=="r" or i[2]=="FLAGS":
                i[0]+="r"
            elif i[1]=="FLAGS":
